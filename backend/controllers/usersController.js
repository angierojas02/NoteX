...
import { validateUser, validateEditUser } from '../schema/User.js'
...
const loginUser = async (req, res, next) => {
    try {
        ...
        if (!userAuth) {
            const errorAuth = new Error('Incorrect username or password')
...
const modifyUser = async (req, res, next) => {
    try {
        ...
        const result = validateEditUser(req.body)
        ...
        if (!userFound) {
            const errorCustom = new Error('User not found')
